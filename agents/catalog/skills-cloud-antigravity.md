...
graph TD
    subgraph "OpenCode Ecosystem"
        OC[Orquestrador MarceloClaro]
        CAT[Catálogo 160+ Agentes]
        MCI[Memória Metacognitiva]
    end

    subgraph "Antigravity Backup Skills"
        SKILLS[56 Skills Cloud]
        SCRIPTS[269 Scripts Operacionais]
    end

    subgraph "Novos Agentes Cloud"
        A1[cloud-alloydb-specialist]
        A2[cloud-bigquery-specialist]
        A3[cloud-sql-postgres-specialist]
        A4[cloud-sql-mysql-specialist]
        A5[cloud-sql-sqlserver-specialist]
        A6[cloud-data-pipelines-specialist]
        A7[cloud-security-specialist]
        A8[cloud-data-infra-generalist]
    end

    SKILLS --> A1 & A2 & A3 & A4 & A5 & A6 & A7 & A8
    SCRIPTS --> A1 & A2 & A3 & A4 & A5 & A6 & A7 & A8
    A1 & A2 & A3 & A4 & A5 & A6 & A7 & A8 --> CAT
    OC --> A1
    MCI --> A1
```
