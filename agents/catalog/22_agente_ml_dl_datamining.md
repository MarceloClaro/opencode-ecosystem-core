...
description: "Projetar, auditar e comparar pipelines de aprendizado de maquina e mineracao de dados com rigor de baseline, generalizacao, interpretabilidade e reproducibilidade."
version: '1.0.0'
skills:
- id: 22-agente-ml-dl
...
> Conteúdo migrado de `criador-artigo/agents/22_agente_ml_dl_datamining.md` (SPEC-935-R380): o card anterior era um stub com descrição placeholder e corpo apontando para um caminho externo inexistente neste checkout. Seções de referência a arquivos não migrados (`references/*.md`, `templates/*.md` do projeto de origem) foram omitidas — não fabricadas.
