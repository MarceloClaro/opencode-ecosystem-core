...
venue: "arXiv"
source: arxiv
pdf: [2022] - a-survey-of-multi-agent-deep-reinforcement-learning-with-communication.pdf
...
In the cooperative setting where agents share a common reward, the update rule for agent i is as follows:
                             ...
                             Qi (s, ai ) ← Qi (s, ai ) + α(r + γ max    Qi (s′ , a′i ) − Qi (s, ai ) )                        (1)
                                                                  a′i
                                                           |          {z            }    | {z }
...
the policy gradient theorem is expressed as follows:
                                 ∇θ J(θ) = E⃗a∼π(·|s),s∼ρπ [∇θ log π(⃗a | s; θ)Qπ (s, ⃗a)]                             (3)
...
                                                             Multi-agent Reinforcement Learning Tasks
                                        ...
                                        Emergent   Learning Tasks with Learning Tasks with
                                        Language   Emergent Language     Communication
...
                          Table 1: Proposed dimensions and associated research questions.
    Key Components         Target Questions                                   Dimensions                     Index
                           What kind of behaviors are desired to emerge Controlled Goals                     ⃝1
    Problem Settings       with communication?
                           How to fulfill realistic requirements?             Communication Con-             ⃝
                                                                                                             2
                                                                              straints
                           Which type of agents to communicate with?          Communicatee Type              ⃝
                                                                                                             3
                           When and how to build communication links Communication Policy                    ⃝
                                                                                                             4
    Communication          among agents?
      Processes            Which piece of information to share?               Communicated Mes-              ⃝
                                                                                                             5
                                                                              sages
                           How to combine received messages?                  Message Combination            ⃝
                                                                                                             6
                           How to integrate combined messages into learn- Inner Integration                  ⃝
                                                                                                             7
                           ing models?
                           How to train and improve communication?            Learning Methods               ⃝
                                                                                                             8
    Training Processes
                           How to utilize collected experience from agents? Training Schemes                 ⃝
                                                                                                             9
...
Require: N reinforcement learning agents
 1: Set goals for reinforcement learning agents                                                          ▷ Dimension ⃝
                                                                                                                     1
 2: Set possible communication constraints                                                               ▷ Dimension ⃝
                                                                                                                     2
 3: Set the type of communicatees                                                                        ▷ Dimension ⃝
                                                                                                                     3
 4: for episode = 1, 2, ... do
 5:     for every environment step do
 6:          Decide with whom and whether to communicate                                                 ▷ Dimension ⃝
                                                                                                                     4
 7:          Decide which piece of information to share                                                  ▷ Dimension ⃝
                                                                                                                     5
 8:          Combine received information shared from others                                             ▷ Dimension ⃝
                                                                                                                     6
 9:          Integrate messages into agents’ internal models                                             ▷ Dimension ⃝
                                                                                                                     7
...
14:          Update agents’ policies, value function, and communication processes                 ▷ Dimensions ⃝
                                                                                                               8 &⃝
                                                                                                                  9
15:     end if
16: end for
...
                                         Table 2: The category of controlled goals.
 ...
 Cooperative            Global Rewards               DIAL [73]; RIAL [73]; CommNet [48]; GCL [61]; MAGNet-
                        ...
                        Local Rewards                BiCNet [50]; DGN [81]; IC3Net [49]; MD-MADDPG [42];
                                                     DCC-MD [82]; GA-Comm [83]; NeurComm [84]; IP [85];
                                                     ETCNet [86]; Variable-length Coding [87]; AE-Comm [65];
                        Global or Local Rewards      MS-MARL-GCM [88]; ATOC [39]; TarMAC [89]; IS [90];
                                                     HAMMER [91]; MAGIC [92]; FlowComm [93]; FCMNet
                                                     [94];
 Competitive            Conflict Rewards             IC3Net [49]; R-MACRL [95];
 Mixed                  Self-interested Rewards      IC [62]; DGN [81]; TarMAC [89]; IC3Net [49]; NDQ [75];
                                                     LSC [77]; MAGIC [92];
...
                                Table 3: The category of communication constraints.
 ...
 Unconstrained Communi-                       CommNet [48]; BiCNet [50]; MS-MARL-GCM [88]; ATOC
 cation                                       [39]; DGN [81]; TarMAC [89]; MAGNet-SA-GS-MG [40];
 ...
 Constrained Communica-     Limited Band-     RIAL [73]; DIAL [73]; GCL [61]; IC [62]; SchedNet [43]; VBC
 tion                       width             [31]; NDQ [75]; IMAC [66]; Gated-ACML [76]; Bias [63]; ETC-
                                              Net [86]; Variable-length Coding [87]; TMC [32]; AE-Comm
                                              [65]; MAIC [33];
                            Corrupted         DIAL [73]; Diff Discrete[78]; DCSS [64]; R-MACRL [95];
                            Messages
...
• Limited Bandwidth. In this category, communication bandwidth is limited by channel capacity. Thus, communi-
...
                                      Table 4: The category of communicatee type.
 Types                 Subtypes                        Methods
 Agents in the MAS     Nearby Agents                   DGN [81]; MAGNet-SA-GS-MG [40]; Agent-Entity Graph [74];
                                                       LSC [77]; NeurComm [84]; IP [85]; FlowComm [93]; GAXNet
                                                       [80];
                       Other Agents                    DIAL [73]; RIAL [73]; CommNet [48]; GCL [61]; BiCNet [50];
 ...
 Proxy                                                 MS-MARL-GCM [88]; ATOC [39]; MD-MADDPG [42]; IMAC
...
                                        Table 5: The category of communication policy
 Types                 Subtypes                    Methods
 Predefined            Full Communication          DIAL [73]; RIAL [73]; CommNet [48]; GCL [61]; BiCNet
                       ...
                       Partial Structure           IC [62]; DGN [81]; MAGNet-SA-GS-MG [40]; Agent-Entity
                                                   Graph [74]; VBC [31]; NDQ [75]; Bias [63]; NeurComm [84];
                                                   IP [85]; TMC [32]; GAXNet [80]; DCSS [64]; MAIC [33];
 Learnable             Individual Control          ATOC [39]; MADDPG-M [41]; IC3Net [49]; Gated-ACML
                                                   [76]; LSC [77]; I2C [79]; ETCNet [86];
                       Global Control              SchedNet [43]; GA-Comm [83]; MAGIC [92]; FlowComm
                                                   [93];

                                                                                                     Comm
                                                                       Comm
  A1             A1                  A1              A1             A1 Policy 1   A1           A1    Policy   A1

                                                                        Comm
  A2             A2                  A2              A2             A2 Policy 2   A2           A2             A2
  ...            ...                 ...             ...            ...           ...          ...            ...
                                                                       Comm
  An             An                  An              An             An Policy n   An           An             An
...
                                  Table 6: The category of communicated messages.
 Types                        Methods
 Existing Knowledge           DIAL [73]; RIAL [73]; CommNet [48]; GCL [61]; BiCNet [50]; MS-MARL-
 ...
 Imagined Future Knowledge    ATOC [39]; NeurComm [84]; IP [85]; IS [90];
  ...
  Types                         Methods
  Equally Valued                DIAL [73]; RIAL [73]; CommNet [48]; GCL [61]; IC [62]; MADDPG-M [41];
                                ...
                                [65]; DCSS [64];
  Unequally Valued              BiCNet [50]; MS-MARL-GCM [88]; ATOC [39]; DGN [81]; TarMAC [89];
...
                                       Table 8: The category of inner integration.
   Types                         Methods
   Policy-level                  CommNet [48]; GCL [61]; MS-MARL-GCM [88]; ATOC [39]; MAGNet-SA-
   ...
   Value-level                   DIAL [73]; RIAL [73]; DGN [81]; DCC-MD [82]; VBC [31]; NDQ [75]; LSC
                                 [77]; TMC [32]; MAIC [33];
   Policy- and Value-level       BiCNet [50]; IC [62]; TarMAC [89]; MADDPG-M [41]; Agent-Entity Graph [74];
...
                             Table 9: The assumptions behind different learning methods.
    Types                                   Assumptions
    Fully differentiable                    The messages or the communication actions are generated by a differ-
                                            entiable function and thus backpropagation is used everywhere.
    Supervised learning                     True labels (or the ground truth) are assumed to be given or defined to
                                            guide the learning of communication policy or messages.
    Reinforcement learning                  Environment rewards or self-defined rewards are used to update com-
                                            munication policy or messages incrementally.
    Regularizers                            Regularizations such as entropy inspired from information theory are
 ...
 Types                       Methods
 Differentiable              GCL [61]; DIAL [73]; CommNet [48]; BiCNet [50]; MS-MARL-GCM [88]; DGN
 ...
 Reinforced                  GCL [61]; RIAL [73]; IC [62]; MADDPG-M [41]; IC3Net [49]; SchedNet [43];
...
                       Environment                                                          Environment
     ...
     Policy 1       Policy 2     ...      Policy n                                                           ...
           ...
           Update with <r1, r2, ..., rn>                            Update with r1 Update with r2                  Update with rn

           (a) Fully Centralized Learning                                           (b) Fully Decentralized Learning
                 Environment                                                            Environment

a1    o1          a2     o2             an    on                       a1      o1         a2    o2           an      on

Policy 1          Policy 2     ...     Policy n                      Policy 1            Policy 2      ...   Policy n

Update            Update                Update                         Update

                                       Global Information                                                    Global Information
             Central Unit                 e.g., rewards
                                                                                       Central Unit             e.g., rewards

                (c) Individual Parameters                                                (d) Parameter Sharing
                                                       Environment
                               ...
                               Central Unit 1         Central Unit 2         Central Unit n
...
                                       Table 11: The category of training schemes.
 Types                    Subtypes               Methods
 Fully    Decentralized                          IC [62]; MAGNet-SA-GS-MG [40]; MADDPG-M [41]; DCC-
 Learning                                        MD [82]; Agent-Entity Graph [74]; Bias [63]; NeurComm [84];
                                                 IP [85]; AE-Comm [65]; R-MACRL [95];
 Centralized Training     Individual Parame-     MS-MARL-GCM [88]; SchedNet [43]; IMAC [66]; Gated-
 and      Decentralized   ters                   ACML [76]; GAXNet [80]; DCSS [64];
 Execution
                          Parameter Sharing      DIAL [73]; RIAL [73]; CommNet [48]; GCL [61]; BiCNet
...
• Concurrent. In scenarios where storing all experiences in a central unit is not feasible, agents can alternatively
  create backups of all experiences, with the assumption that they are able to observe other agents’ actions and obser-
...
                                       Table 12: The notations of all categories.
    ...
    Controlled Goals (CG)                Coo : Cooperative; Com : Competitive; M: Mixed
    Communication Constraints (CC)       U: Unconstrained Communication;Lb : Limited Bandwidth; Cm : Cor-
                                         rupted Messages;
    Communicatee Type (CT)               Na : Nearby Agents; A: Other (Learning) Agents; P: Proxy
    Communication Policy (CP)            Fc : Full Communication; Ps : Predefined (Partial) Structure; Ic : Individ-
                                         ual Control; Gc : Global Control
    Communicated Messages (CM)           E: Existing Knowledge; I: Imagined Future Knowledge
    Message Combination (MC)             Ve : Equally Valued; Vu : Unequally Valued
    Inner Integration (II)               Pl : Policy-level; Vl : Value-level; PV: Policy-level & Value-level
    Learning Methods (LM)                D: Differentiable; Sp : Supervised; Re : Reinforced; Rg : Regularized
    Training Schemes (TS)                CL: Centralized Learning; DL: Decentralized Learning; CT DE ip :
                                         CTDE with Individual (Policy) Parameters; CT DE ps : CTDE with Pa-
                                         rameter Sharing; CT DE c : Concurrent CTDE
...
• In the dimension of Communication Constraints, many existing works do not account for communication con-
  ...
  veying too much information might benefit others while sacrificing the agent’s own learning opportunities. The
...
• In the dimension of Communication Policy, current works often assume a binary communication action regarding
  ...
  requirements.
• In the dimension of Communicated Messages, various methods have been proposed to utilize the existing knowl-
  edge of agents for message generation. Some existing works consider incorporating agents’ intentions or future
...
but in separate environments or settings.
    ...
    DIAL [73]            Coo       Lb +Cm    A         Fc        E         Ve        Vl         D        CT DE ps
    RIAL [73]            Coo       Lb        A         Fc        E         Ve        Vl         Re       CT DE ps
    CommNet [48]         Coo       U         A         Fc        E         Ve        Pl         D        CT DE ps
    GCL [61]             Coo       Lb        A         Fc        E         Ve        Pl         D+Re     CT DE ps
    BiCNet [50]          Coo       U         A         Fc        E         Vu        PV         D        CT DE ps
    MS-MARL-             Coo       U         P         Fc        E         Vu        Pl         D        CT DE ip
    GCM [88]
    ATOC [39]            Coo       U         P         Ic        I         Vu        Pl         Sp       CT DE ps
    IC [62]              Coo       Lb        A         Fc        E         Ve        PV         Re       DL
    DGN [81]             Coo /M    U         Na        Ps        E         Vu        Vl         D        CT DE ps
    TarMAC [89]          Coo /M    U         A         Fc        E         Vu        PV         D        CT DE ps
    MAGNet-SA-           Coo       U         Na        Ps        E         Vu        Pl         D        DL
    GS-MG [40]
    MADDPG-M             Coo       U         A         Ic        E         Ve        PV         Re       DL
    [41]
    IC3Net [49]          Coo /Com /M
                                   U         A         Ic        E         Ve        Pl         Re       CT DE ps
    MD-MADDPG            Coo       U         P         Fc        E         Vu        Pl         D        CT DE c
    [42]
    SchedNet [43]        Coo       Lb        A         Gc        E         Ve        Pl         Re       CT DE ip
    DCC-MD [82]          Coo       U         A         Fc        E         Vu        Vl         D        DL
    Agent-Entity         Coo       U         Na        Ps        E         Vu        PV         D        DL
    Graph [74]
    VBC [31]             Coo       Lb        A         Ps        E         Ve        Vl         D        CT DE ps
    NDQ [75]             Coo /M    Lb        A         Ps        E         Ve        Vl         Rg       CT DE ps
    IMAC [66]            Coo       Lb        P         Fc        E         Vu        Pl         Rg       CT DE ip
    GA-Comm [83]         Coo       U         P         Gc        E         Vu        Pl         D        CT DE ps
    Gated-ACML           Coo       Lb        P         Ic        E         Vu        Pl         Sp       CT DE ip
    [76]
    Bias [63]            Coo       Lb        A         Fc        E         Ve        PV         Rg       DL
    LSC [77]             Coo /M    U         Na        Ic        E         Vu        Vl         Re       CT DE ps
    Diff Discrete[78]    Coo       Cm        A         Fc        E         Ve        Pl         D        CT DE ps
    NeurComm [84]        Coo       U         Na        Ps        I         Vu        PV         D        DL
    IP [85]              Coo       U         Na        Ps        I         Vu        Pl         D        DL
    I2C [79]             Coo       U         A         Ic        E         Vu        Pl         Sp       CT DE ps
    IS [90]              Coo       U         A         Fc        I         Ve        Pl         D        CT DE c
    ETCNet [86]          Coo       Lb        A         Ic        E         Ve        Pl         Re       CT DE ps
                                                                                          Continued on next page


                                                         23
      Variable-length    Coo       Lb        A          Fc        E         Ve        Pl         D         CT DE ps
      Coding [87]
      TMC [32]           Coo       Lb        A          Ps        E         Vu        Vl         D         CT DE ps
      HAMMER [91]        Coo       U         P          Fc        E         Vu        Pl         Re        CT DE ps
      MAGIC [92]         Coo /M    U         P          Gc        E         Vu        PV         D         CT DE ps
      FlowComm [93]      Coo       U         Na         Gc        E         Ve        Pl         D         CT DE ps
      AE-Comm [65]       Coo       Lb        A          Fc        E         Ve        PV         Rg        DL
      GAXNet [80]        Coo       U         Na         Ps        E         Vu        Pl         D         CT DE ip
      DCSS [64]          Coo       Cm        P          Fc        E         Ve        PV         D+Sp      CT DE ip
      R-MACRL [95]       Com       Cm        A          Fc        E         Vu        Pl         Sp        DL
      MAIC [33]          Coo       Lb        A          Ps        E         Vu        Vl         Rg        CT DE ps
      FCMNet [94]        Coo       U         A          Fc        E         Vu        PV         D         CT DE ps
...
• Reward-based: This metric employs the converged return or average rewards per episode or time step to demon-
...
• Emergence Degree: Originating from the field of emergent language, this metric evaluates and detects the emer-
...
                                 
                  ...
                   & R X Q W     
                               ...
                                 
                                ...
                                 
                                       5 H Z D U G  E D V H G    : L Q  R U  ) D L O  5 D W H    6 W H S V  7 D N H Q    & R P P X Q L F D W L R Q  ( I I L F L H Q F \    ( P H U J H Q F H  ' H J U H H
...
References
    ...
    [8] Jakob N. Foerster, Gregory Farquhar, Triantafyllos Afouras, Nantas Nardelli, and Shimon Whiteson. Coun-
        ...
        gence (EAAI-18), New Orleans, Louisiana, USA, February 2-7, 2018, pages 2974–2982, 2018.
    [9] Georgios Papoudakis, Filippos Christianos, Arrasy Rahman, and Stefano V. Albrecht. Dealing with non-
 ...
 [12] Volodymyr Mnih, Koray Kavukcuoglu, David Silver, Andrei A. Rusu, Joel Veness, Marc G. Bellemare, Alex
      ...
      abis. Human-level control through deep reinforcement learning. Nature, 518(7540):529–533, 2015.
...
[16] Pablo Hernandez-Leal, Bilal Kartal, and Matthew E. Taylor. A survey and critique of multiagent deep rein-
     forcement learning. Auton. Agents Multi Agent Syst., 33(6):750–797, 2019.
...
[32] Sai Qian Zhang, Qi Zhang, and Jieyu Lin. Succinct and robust multi-agent communication with temporal
     message control. In Hugo Larochelle, Marc’Aurelio Ranzato, Raia Hadsell, Maria-Florina Balcan, and Hsuan-
...
[35] Vijay R. Konda and John N. Tsitsiklis. Actor-critic algorithms. In Sara A. Solla, Todd K. Leen, and Klaus-
     Robert Müller, editors, Advances in Neural Information Processing Systems 12, NIPS Conference, pages 1008–
     1014, 1999.
...
[48] Sainbayar Sukhbaatar, Arthur Szlam, and Rob Fergus. Learning multiagent communication with backpropaga-
     tion. In Advances in Neural Information Processing Systems 29 (NIPS), pages 2244–2252, 2016.
...
[54] Rahma Chaabouni, Florian Strub, Florent Altché, Eugene Tarassov, Corentin Tallec, Elnaz Davoodi, Kory Wal-
...
[82] Woojun Kim, Myungsik Cho, and Youngchul Sung. Message-dropout: An efficient training method for multi-
     agent deep reinforcement learning. In The Thirty-Third AAAI Conference on Artificial Intelligence, pages 6079–
     6086, 2019.
...
 [85] Chao Qu, Hui Li, Chang Liu, Junwu Xiong, James Zhang, Wei Chu, Yuan Qi, and Le Song. Intention propaga-
 ...
 [92] Yaru Niu, Rohan R. Paleja, and Matthew C. Gombolay. Multi-agent graph-attention communication and team-
      ing. In 20th International Conference on Autonomous Agents and Multiagent Systems (AAMAS), pages 964–
      973, 2021.
...
[110] Davide Calvaresi, Alevtina Dubovitskaya, Jean-Paul Calbimonte, Kuldar Taveter, and Michael Schumacher.
      ...
      Javier Bajo, and Antonio Fernández-Caballero, editors, Advances in Practical Applications of Agents, Multi-
...
      Learning, ICML 2017, Sydney, NSW, Australia, 6-11 August 2017, volume 70 of Proceedings of Machine Learn-
      ing Research, pages 2817–2826, 2017.
[120] Anay Pattanaik, Zhenyi Tang, Shuijing Liu, Gautham Bommannan, and Girish Chowdhary. Robust deep re-
      inforcement learning with adversarial attacks. In Elisabeth André, Sven Koenig, Mehdi Dastani, and Gita
