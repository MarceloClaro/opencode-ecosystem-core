# sql-query-agent — espelho 04-sql-query-agent
...
- **Pasta-fonte**: `agents/04-sql-query-agent`
- **Descrição**: Answers natural language questions about SQL databases by generating and executing queries
- **Framework**: langchain · **LLM original**: gpt-4o-mini
- **Tags**: sql, database, natural-language, data-analysis
...
Sugestão de ciclo: spec `SPEC-935-R***-sql-query-agent.md` → RED → GREEN → verificação
...
---
*Gerado a partir do espelho local em `agents/04-sql-query-agent`.*
