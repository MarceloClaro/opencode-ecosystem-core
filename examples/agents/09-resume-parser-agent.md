# resume-parser-agent — espelho 09-resume-parser-agent
...
- **Pasta-fonte**: `agents/09-resume-parser-agent`
- **Descrição**: Parses resumes to structured JSON and scores candidate fit against job descriptions
...
Sugestão de ciclo: spec `SPEC-935-R***-resume-parser-agent.md` → RED → GREEN → verificação
...
---
*Gerado a partir do espelho local em `agents/09-resume-parser-agent`.*
