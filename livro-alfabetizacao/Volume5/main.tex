%% ============================================================
%% Volume 5 — Capa e Páginas Preliminares (gerado por expandir_volume.py)
%% ============================================================
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{28}{34}\selectfont\bfseries\color{primary}, text width=12cm, align=center]
    at (current page.center) {VOLUME 5\\[0.5em]\large Alfabetizar Bem --- 5º Ano};
  \node[anchor=south, font=\small\color{white}, text width=14cm, align=center]
    at ([yshift=3.5cm]current page.south) {\textbf{Alinhamento Curricular}\\BNCC (EF05LP01, EF05LP02, EF05LP03, EF05LP04, EF05LP05, EF05LP08, EF05LP10) \quad$\cdot$\quad Matriz CAEd \quad$\cdot$\quad SPAECE};
