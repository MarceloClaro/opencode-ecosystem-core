%% ============================================================
%% Volume 2 — Capa e Páginas Preliminares (gerado por expandir_volume.py)
%% ============================================================
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{28}{34}\selectfont\bfseries\color{primary}, text width=12cm, align=center]
    at (current page.center) {VOLUME 2\\[0.5em]\large 2º Ano do Ensino Fundamental};
  \node[anchor=south, font=\small\color{white}, text width=14cm, align=center]
    at ([yshift=3.5cm]current page.south) {\textbf{Alinhamento Curricular}\\BNCC (EF02LP01--EF02LP10) \quad$\cdot$\quad Matriz CAEd \quad$\cdot$\quad SPAECE};
