% SEQUÊNCIA DIDÁTICA — Volume 2 (gerado por expandir_volume.py)

%% ============================================
%% UNIDADE 0 -- Prontidão para o 2º Ano
%% ============================================

\chapter{Unidade 0 --- Prontidão para o 2º Ano}

\metadata{I-00}{Silábico-Alfabético Avançado}{EF02LP01}{D1}{EF02LP01}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 0.1 --- Revisão de vogais e sílabas simples}

\textbf{Foco da lição:} Revisão de vogais e sílabas simples
...
\plancheta{Folha de Prática 0.1 --- Prontidão para o 2º Ano (Parte 1)}

\begin{exercicio}[Folha de Prática 0.1 --- Prontidão para o 2º Ano (Parte 1)]
...
\plancheta{Folha de Prática 0.2 --- Prontidão para o 2º Ano (Parte 2)}

\begin{exercicio}[Folha de Prática 0.2 --- Prontidão para o 2º Ano (Parte 2)]
...
%% ============================================
%% UNIDADE 1 -- Dígrafo CH
%% ============================================

\chapter{Unidade 1 --- Dígrafo CH}

\metadata{I-01}{Silábico-Alfabético Avançado}{EF02LP03}{D1}{EF02LP03}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 1.1 --- O som /ch/ e as grafias CH}

\textbf{Foco da lição:} O som /ch/ e as grafias CH
...
\plancheta{Folha de Prática 1.1 --- Dígrafo CH (Parte 1)}

\begin{exercicio}[Folha de Prática 1.1 --- Dígrafo CH (Parte 1)]
...
\plancheta{Folha de Prática 1.2 --- Dígrafo CH (Parte 2)}

\begin{exercicio}[Folha de Prática 1.2 --- Dígrafo CH (Parte 2)]
...
%% ============================================
%% UNIDADE 2 -- Dígrafo LH
%% ============================================

\input{checkpoints/rastreio-u1}
\chapter{Unidade 2 --- Dígrafo LH}

\metadata{I-02}{Silábico-Alfabético Avançado}{EF02LP03}{D1}{EF02LP03}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 2.1 --- O som /lh/ e a grafia LH}

\textbf{Foco da lição:} O som /lh/ e a grafia LH
...
\plancheta{Folha de Prática 2.1 --- Dígrafo LH (Parte 1)}

\begin{exercicio}[Folha de Prática 2.1 --- Dígrafo LH (Parte 1)]
...
\plancheta{Folha de Prática 2.2 --- Dígrafo LH (Parte 2)}

\begin{exercicio}[Folha de Prática 2.2 --- Dígrafo LH (Parte 2)]
...
%% ============================================
%% UNIDADE 3 -- Dígrafo NH
%% ============================================

\chapter{Unidade 3 --- Dígrafo NH}

\metadata{I-03}{Silábico-Alfabético Avançado}{EF02LP03}{D1}{EF02LP03}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 3.1 --- O som /nh/ e a grafia NH}

\textbf{Foco da lição:} O som /nh/ e a grafia NH
...
\plancheta{Folha de Prática 3.1 --- Dígrafo NH (Parte 1)}

\begin{exercicio}[Folha de Prática 3.1 --- Dígrafo NH (Parte 1)]
...
\plancheta{Folha de Prática 3.2 --- Dígrafo NH (Parte 2)}

\begin{exercicio}[Folha de Prática 3.2 --- Dígrafo NH (Parte 2)]
...
\chapter{Unidade 4 --- QU e GU}

\metadata{I-04}{Silábico-Alfabético Avançado}{EF02LP07}{D1}{EF02LP07}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 4.1 --- Os digrafos QU e GU nas sílabas QUE e QUI}

\textbf{Foco da lição:} Os digrafos QU e GU nas sílabas QUE e QUI
...
\plancheta{Folha de Prática 4.1 --- QU e GU (Parte 1)}

\begin{exercicio}[Folha de Prática 4.1 --- QU e GU (Parte 1)]
...
\plancheta{Folha de Prática 4.2 --- QU e GU (Parte 2)}

\begin{exercicio}[Folha de Prática 4.2 --- QU e GU (Parte 2)]
...
%% ============================================
%% UNIDADE 5 -- Encontros Consonantais (1): BR, CR, DR, FR, GR, PR, TR, VR
%% ============================================

\chapter{Unidade 5 --- Encontros Consonantais (1): BR, CR, DR, FR, GR, PR, TR, VR}

\metadata{I-05}{Silábico-Alfabético Avançado}{EF02LP04}{D1}{EF02LP04}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 5.1 --- Os encontros consonantais do bloco 1}

\textbf{Foco da lição:} Os encontros consonantais do bloco 1
...
\plancheta{Folha de Prática 5.1 --- Encontros Consonantais (1): BR, CR, DR, FR, GR, PR, TR, VR (Parte 1)}

\begin{exercicio}[Folha de Prática 5.1 --- Encontros Consonantais (1): BR, CR, DR, FR, GR, PR, TR, VR (Parte 1)]
...
\plancheta{Folha de Prática 5.2 --- Encontros Consonantais (1): BR, CR, DR, FR, GR, PR, TR, VR (Parte 2)}

\begin{exercicio}[Folha de Prática 5.2 --- Encontros Consonantais (1): BR, CR, DR, FR, GR, PR, TR, VR (Parte 2)]
...
%% ============================================
%% UNIDADE 6 -- Encontros Consonantais (2): BL, CL, FL, GL, PL, TL
%% ============================================

\input{checkpoints/rastreio-u3}
\chapter{Unidade 6 --- Encontros Consonantais (2): BL, CL, FL, GL, PL, TL}

\metadata{I-06}{Silábico-Alfabético Avançado}{EF02LP04}{D1}{EF02LP04}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 6.1 --- Os encontros consonantais com L}

\textbf{Foco da lição:} Os encontros consonantais com L
...
\plancheta{Folha de Prática 6.1 --- Encontros Consonantais (2): BL, CL, FL, GL, PL, TL (Parte 1)}

\begin{exercicio}[Folha de Prática 6.1 --- Encontros Consonantais (2): BL, CL, FL, GL, PL, TL (Parte 1)]
...
\plancheta{Folha de Prática 6.2 --- Encontros Consonantais (2): BL, CL, FL, GL, PL, TL (Parte 2)}

\begin{exercicio}[Folha de Prática 6.2 --- Encontros Consonantais (2): BL, CL, FL, GL, PL, TL (Parte 2)]
...
\chapter{Unidade 7 --- RR e SS}

\metadata{I-07}{Silábico-Alfabético Avançado}{EF02LP07}{D1}{EF02LP07}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 7.1 --- Os digrafos RR e SS entre vogais}

\textbf{Foco da lição:} Os digrafos RR e SS entre vogais
...
\plancheta{Folha de Prática 7.1 --- RR e SS (Parte 1)}

\begin{exercicio}[Folha de Prática 7.1 --- RR e SS (Parte 1)]
...
\plancheta{Folha de Prática 7.2 --- RR e SS (Parte 2)}

\begin{exercicio}[Folha de Prática 7.2 --- RR e SS (Parte 2)]
...
\chapter{Unidade 8 --- S, SS e Z}

\metadata{I-08}{Silábico-Alfabético Avançado}{EF02LP07}{D1}{EF02LP07}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 8.1 --- O som de S, o som de Z e as grafias entre vogais}

\textbf{Foco da lição:} O som de S, o som de Z e as grafias entre vogais
...
\plancheta{Folha de Prática 8.1 --- S, SS e Z (Parte 1)}

\begin{exercicio}[Folha de Prática 8.1 --- S, SS e Z (Parte 1)]
...
\plancheta{Folha de Prática 8.2 --- S, SS e Z (Parte 2)}

\begin{exercicio}[Folha de Prática 8.2 --- S, SS e Z (Parte 2)]
...
\chapter{Unidade 9 --- A Letra Ç}

\metadata{I-09}{Silábico-Alfabético Avançado}{EF02LP07}{D1}{EF02LP07}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 9.1 --- O som de Ç e os usos da cedilha}

\textbf{Foco da lição:} O som de Ç e os usos da cedilha
...
\plancheta{Folha de Prática 9.1 --- A Letra Ç (Parte 1)}

\begin{exercicio}[Folha de Prática 9.1 --- A Letra Ç (Parte 1)]
...
\plancheta{Folha de Prática 9.2 --- A Letra Ç (Parte 2)}

\begin{exercicio}[Folha de Prática 9.2 --- A Letra Ç (Parte 2)]
...
%% ============================================
%% UNIDADE 10 -- Ortografia AM e AN
%% ============================================

\input{checkpoints/rastreio-u5}
\chapter{Unidade 10 --- Ortografia AM e AN}

\metadata{I-10}{Silábico-Alfabético Avançado}{EF02LP04}{D1}{EF02LP04}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 10.1 --- As grafias AM e AN no final e no meio de palavras}

\textbf{Foco da lição:} As grafias AM e AN no final e no meio de palavras
...
\plancheta{Folha de Prática 10.1 --- Ortografia AM e AN (Parte 1)}

\begin{exercicio}[Folha de Prática 10.1 --- Ortografia AM e AN (Parte 1)]
...
\plancheta{Folha de Prática 10.2 --- Ortografia AM e AN (Parte 2)}

\begin{exercicio}[Folha de Prática 10.2 --- Ortografia AM e AN (Parte 2)]
...
%% ============================================
%% UNIDADE 11 -- Palavras com X
%% ============================================

\chapter{Unidade 11 --- Palavras com X}

\metadata{I-11}{Silábico-Alfabético Avançado}{EF02LP04}{D1}{EF02LP04}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 11.1 --- Os sons do X: CH, Z, KS e SS}

\textbf{Foco da lição:} Os sons do X: CH, Z, KS e SS
...
\plancheta{Folha de Prática 11.1 --- Palavras com X (Parte 1)}

\begin{exercicio}[Folha de Prática 11.1 --- Palavras com X (Parte 1)]
...
\plancheta{Folha de Prática 11.2 --- Palavras com X (Parte 2)}

\begin{exercicio}[Folha de Prática 11.2 --- Palavras com X (Parte 2)]
...
%% ============================================
%% UNIDADE 12 -- Revisão Geral e Fluência
%% ============================================

\chapter{Unidade 12 --- Revisão Geral e Fluência}

\metadata{I-12}{Silábico-Alfabético Avançado}{EF02LP10}{D1}{EF02LP10}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 12.1 --- Leitura de texto curto com todas as grafias do ano}

\textbf{Foco da lição:} Leitura de texto curto com todas as grafias do ano
...
\plancheta{Folha de Prática 12.1 --- Revisão Geral e Fluência (Parte 1)}

\begin{exercicio}[Folha de Prática 12.1 --- Revisão Geral e Fluência (Parte 1)]
...
\plancheta{Folha de Prática 12.2 --- Revisão Geral e Fluência (Parte 2)}

\begin{exercicio}[Folha de Prática 12.2 --- Revisão Geral e Fluência (Parte 2)]
...
%% ============================================
%% UNIDADE 13 -- Revisão dos Dígrafos CH, LH e NH
%% ============================================

\chapter{Unidade 13 --- Revisão dos Dígrafos CH, LH e NH}

\metadata{I-13}{Silábico-Alfabético Avançado}{EF02LP03}{D1}{EF02LP03}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 13.1 --- Consolidar CH, LH e NH em leitura e escrita}

\textbf{Foco da lição:} Consolidar CH, LH e NH em leitura e escrita
...
\plancheta{Folha de Prática 13.1 --- Revisão dos Dígrafos CH, LH e NH (Parte 1)}

\begin{exercicio}[Folha de Prática 13.1 --- Revisão dos Dígrafos CH, LH e NH (Parte 1)]
...
\plancheta{Folha de Prática 13.2 --- Revisão dos Dígrafos CH, LH e NH (Parte 2)}

\begin{exercicio}[Folha de Prática 13.2 --- Revisão dos Dígrafos CH, LH e NH (Parte 2)]
...
%% ============================================
%% UNIDADE 14 -- Revisão dos Encontros Consonantais
%% ============================================

\chapter{Unidade 14 --- Revisão dos Encontros Consonantais}

\metadata{I-14}{Silábico-Alfabético Avançado}{EF02LP04}{D1}{EF02LP04}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 14.1 --- Consolidar os encontros BR–VR e BL–TL}

\textbf{Foco da lição:} Consolidar os encontros BR–VR e BL–TL
...
\plancheta{Folha de Prática 14.1 --- Revisão dos Encontros Consonantais (Parte 1)}

\begin{exercicio}[Folha de Prática 14.1 --- Revisão dos Encontros Consonantais (Parte 1)]
...
\plancheta{Folha de Prática 14.2 --- Revisão dos Encontros Consonantais (Parte 2)}

\begin{exercicio}[Folha de Prática 14.2 --- Revisão dos Encontros Consonantais (Parte 2)]
...
%% ============================================
%% UNIDADE 15 -- Revisão Ortográfica: RR, SS, S/Z e Ç
%% ============================================

\chapter{Unidade 15 --- Revisão Ortográfica: RR, SS, S/Z e Ç}

\metadata{I-15}{Silábico-Alfabético Avançado}{EF02LP07}{D1}{EF02LP07}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 15.1 --- Consolidar as regras ortográficas do ano}

\textbf{Foco da lição:} Consolidar as regras ortográficas do ano
...
\plancheta{Folha de Prática 15.1 --- Revisão Ortográfica: RR, SS, S/Z e Ç (Parte 1)}

\begin{exercicio}[Folha de Prática 15.1 --- Revisão Ortográfica: RR, SS, S/Z e Ç (Parte 1)]
...
\plancheta{Folha de Prática 15.2 --- Revisão Ortográfica: RR, SS, S/Z e Ç (Parte 2)}

\begin{exercicio}[Folha de Prática 15.2 --- Revisão Ortográfica: RR, SS, S/Z e Ç (Parte 2)]
...
%% ============================================
%% UNIDADE 16 -- Leitura de Gêneros: Poema e Cantiga
%% ============================================

\chapter{Unidade 16 --- Leitura de Gêneros: Poema e Cantiga}

\metadata{I-16}{Silábico-Alfabético Avançado}{EF02LP12}{D1}{EF02LP12}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 16.1 --- Ler poema e cantiga com fluência e expressividade}

\textbf{Foco da lição:} Ler poema e cantiga com fluência e expressividade
...
\plancheta{Folha de Prática 16.1 --- Leitura de Gêneros: Poema e Cantiga (Parte 1)}

\begin{exercicio}[Folha de Prática 16.1 --- Leitura de Gêneros: Poema e Cantiga (Parte 1)]
...
\plancheta{Folha de Prática 16.2 --- Leitura de Gêneros: Poema e Cantiga (Parte 2)}

\begin{exercicio}[Folha de Prática 16.2 --- Leitura de Gêneros: Poema e Cantiga (Parte 2)]
...
%% ============================================
%% UNIDADE 18 -- Leitura de Gêneros: Fábula
%% ============================================

\chapter{Unidade 18 --- Leitura de Gêneros: Fábula}

\metadata{I-18}{Silábico-Alfabético Avançado}{EF02LP12}{D1}{EF02LP12}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 18.1 --- Ler fábula, identificar a moral e relacionar com a vida}

\textbf{Foco da lição:} Ler fábula, identificar a moral e relacionar com a vida
...
\plancheta{Folha de Prática 18.1 --- Leitura de Gêneros: Fábula (Parte 1)}

\begin{exercicio}[Folha de Prática 18.1 --- Leitura de Gêneros: Fábula (Parte 1)]
...
\plancheta{Folha de Prática 18.2 --- Leitura de Gêneros: Fábula (Parte 2)}

\begin{exercicio}[Folha de Prática 18.2 --- Leitura de Gêneros: Fábula (Parte 2)]
...
%% ============================================
%% UNIDADE 19 -- Trava-línguas e Rimas
%% ============================================

\chapter{Unidade 19 --- Trava-línguas e Rimas}

\metadata{I-19}{Silábico-Alfabético Avançado}{EF02LP06}{D1}{EF02LP06}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 19.1 --- Articular claramente com trava-línguas e perceber rimas}

\textbf{Foco da lição:} Articular claramente com trava-línguas e perceber rimas
...
\plancheta{Folha de Prática 19.1 --- Trava-línguas e Rimas (Parte 1)}

\begin{exercicio}[Folha de Prática 19.1 --- Trava-línguas e Rimas (Parte 1)]
...
\plancheta{Folha de Prática 19.2 --- Trava-línguas e Rimas (Parte 2)}

\begin{exercicio}[Folha de Prática 19.2 --- Trava-línguas e Rimas (Parte 2)]
...
%% ============================================
%% UNIDADE 20 -- Adivinhas
%% ============================================

\chapter{Unidade 20 --- Adivinhas}

\metadata{I-20}{Silábico-Alfabético Avançado}{EF02LP12}{D1}{EF02LP12}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 20.1 --- Ler adivinhas, deduzir a resposta e justificá-la}

\textbf{Foco da lição:} Ler adivinhas, deduzir a resposta e justificá-la
...
\plancheta{Folha de Prática 20.1 --- Adivinhas (Parte 1)}

\begin{exercicio}[Folha de Prática 20.1 --- Adivinhas (Parte 1)]
...
\plancheta{Folha de Prática 20.2 --- Adivinhas (Parte 2)}

\begin{exercicio}[Folha de Prática 20.2 --- Adivinhas (Parte 2)]
...
%% ============================================
%% UNIDADE 22 -- Revisão Final e Sarau de Leitura
%% ============================================

\chapter{Unidade 22 --- Revisão Final e Sarau de Leitura}

\metadata{I-22}{Silábico-Alfabético Avançado}{EF02LP10}{D1}{EF02LP10}{Resolucao CNE/CEB 7/2010, art. 12}
...
\section{Lição 22.1 --- Revisar todas as grafias do ano e apresentar leitura no sarau}

\textbf{Foco da lição:} Revisar todas as grafias do ano e apresentar leitura no sarau
...
\plancheta{Folha de Prática 22.1 --- Revisão Final e Sarau de Leitura (Parte 1)}

\begin{exercicio}[Folha de Prática 22.1 --- Revisão Final e Sarau de Leitura (Parte 1)]
...
\plancheta{Folha de Prática 22.2 --- Revisão Final e Sarau de Leitura (Parte 2)}

\begin{exercicio}[Folha de Prática 22.2 --- Revisão Final e Sarau de Leitura (Parte 2)]
