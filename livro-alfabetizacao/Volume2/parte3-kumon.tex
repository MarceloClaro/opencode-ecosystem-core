% FOLHAS KUMON — Volume 2 (gerado por expandir_volume.py)

\chapter{Exercícios Kumon --- Folhas de Prática}

\textbf{Instrução:} no 2º ano, cada folha (plancheta reproduzível) dura 10–15 min, com correção imediata e repetição da mesma folha quando o erro aparecer. O ritmo Kumon: poucas folhas por dia, mas todos os dias.
