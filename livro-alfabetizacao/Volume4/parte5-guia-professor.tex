% GUIA DO PROFESSOR — Volume 4 (gerado por expandir_volume.py)

\chapter{Organização do Tempo de Ensino}

No 4º ano, a rotina diária (10–15 min de fônico, 10–15 min de Kumon, 30 min de leitura e escrita) estrutura o tempo. O quadro de horários distribui as unidades da sequência didática e as folhas Kumon por semana, respeitando o ritmo da turma.
...
As DCNC e a BNCC orientam a progressão do 4º ano: leitura e produção de gêneros do cotidiano, análise linguística e consciência fonológica avançada. O livro converge com o que a rede já ensina, sem sobreposição.
