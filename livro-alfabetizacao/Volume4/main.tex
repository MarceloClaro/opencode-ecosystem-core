%% ============================================================
%% Volume 4 — Capa e Páginas Preliminares (gerado por expandir_volume.py)
%% ============================================================
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{28}{34}\selectfont\bfseries\color{primary}, text width=12cm, align=center]
    at (current page.center) {VOLUME 4\\[0.5em]\large Alfabetizar Bem --- 4º Ano};
  \node[anchor=south, font=\small\color{white}, text width=14cm, align=center]
    at ([yshift=3.5cm]current page.south) {\textbf{Alinhamento Curricular}\\BNCC (EF04LP01, EF04LP02, EF04LP03, EF04LP05, EF04LP06, EF04LP07, EF04LP09) \quad$\cdot$\quad Matriz CAEd \quad$\cdot$\quad SPAECE};
