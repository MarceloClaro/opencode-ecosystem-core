% AVALIAÇÕES — Volume 3 (gerado por expandir_volume.py)

\chapter{Avaliações Diagnósticas}

\textbf{Sobre as avaliações:} no 3º ano, aplicam-se três avaliações: diagnóstica (início do ano), formativa (meio) e somativa (fim). Cada avaliação tem itens no formato das matrizes externas (CAEd/SPAECE) e gabarito comentado. As avaliações medem o desenvolvimento, não rotulam o aluno.
