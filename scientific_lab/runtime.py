...
EXPECTED_PACKAGE_MANIFEST_SHA256 = "3fd4f2d4697adb605960b35a73f0677e1ccedf092114f90bb5c2ea13df803a7d"
EXPECTED_SKILL_ARCHIVE_SHA256 = "36c8db9c3b039440c1edf24af21a92e934e814da16a28b8d94c3e5fffe3cefd2"
REQUIRED_CORE = (
...
def installed_status(home: Path | None = None) -> dict:
    ...
    if path is None:
        return {
            ...
            "message": "Instale a supercamada v4.1.1 ou defina PESQUISADOR_UNIVERSAL_HOME.",
        }
    try:
